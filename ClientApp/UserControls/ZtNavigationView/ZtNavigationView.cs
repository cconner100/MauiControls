using static ClientApp.UserControls.ZtNavigationView;
...
namespace ClientApp.UserControls
{
    ...
    public partial class ZtNavigationView : View, IContentView, IZtNavigationView
    {
        public ZtNavigationView()
        {
        }
        ...
        #region Properties
        public static readonly BindableProperty HeaderProperty = BindableProperty.Create("Header", typeof(string), typeof(ZtNavigationView));
        public string Header
        {
            get { return (string)GetValue(HeaderProperty); }
            set { SetValue(HeaderProperty, value); }
        }
        public static readonly BindableProperty AlwaysShowHeaderProperty = BindableProperty.Create("AlwaysShowHeader", typeof(bool), typeof(ZtNavigationView), true);
        public bool AlwaysShowHeader
        {
            get { return (bool)GetValue(AlwaysShowHeaderProperty); }
            set { SetValue(AlwaysShowHeaderProperty, value); }
        }
        public static readonly BindableProperty IsBackButtonVisableProperty = BindableProperty.Create("IsBackButtonVisable", typeof(BackButtonVisable), typeof(ZtNavigationView), BackButtonVisable.Auto);
        ...
        public static readonly BindableProperty IsBackButtonEnabledProperty = BindableProperty.Create("IsBackButtonEnabled", typeof(bool), typeof(ZtNavigationView), false);
        ...
        public static readonly BindableProperty CompactModeThresholdWidthProperty = BindableProperty.Create("CompactModeThresholdWidth", typeof(double), typeof(ZtNavigationView), 641.0);
        ...
        public static readonly BindableProperty CompactPaneLengthProperty = BindableProperty.Create("CompactPaneLength", typeof(double), typeof(ZtNavigationView), 48.0);
        ...
        public static readonly BindableProperty DisplayModeProperty = BindableProperty.Create("DisplayMode", typeof(ViewDisplayMode), typeof(ZtNavigationView), ViewDisplayMode.Minimal);
        ...
        public static readonly BindableProperty ExpandedModeThresholdWidthProperty = BindableProperty.Create("ExpandedModeThresholdWidth", typeof(double), typeof(ZtNavigationView), 1008.0);
        ...
        public static readonly BindableProperty FooterMenuItemsProperty = BindableProperty.Create("FooterMenuItems", typeof(List<object>), typeof(ZtNavigationView));
        ...
        public static readonly BindableProperty FooterMenuItemsSourceProperty = BindableProperty.Create("FooterMenuItemsSource", typeof(object), typeof(ZtNavigationView));
        ...
        public static readonly BindableProperty IsPaneOpenProperty = BindableProperty.Create("IsPaneOpen", typeof(bool), typeof(ZtNavigationView), true);
        ...
        public static readonly BindableProperty IsPaneToggleButtonVisibleProperty = BindableProperty.Create("IsPaneToggleButtonVisible", typeof(bool), typeof(ZtNavigationView), true);
        ...
        public static readonly BindableProperty IsSettingsVisibleProperty = BindableProperty.Create("IsSettingsVisible", typeof(bool), typeof(ZtNavigationView), true);
        ...
        public static readonly BindableProperty IsTitleBarAutoPaddingEnabledProperty = BindableProperty.Create("IsTitleBarAutoPaddingEnabled", typeof(bool), typeof(ZtNavigationView), true);
        ...
        public static readonly BindableProperty MenuItemContainerStyleProperty = BindableProperty.Create("MenuItemContainerStyle", typeof(Style), typeof(ZtNavigationView));
        ...
        public static readonly BindableProperty MenuItemsSourceProperty = BindableProperty.Create("MenuItemsSource", typeof(object), typeof(ZtNavigationView));
        ...
        public static readonly BindableProperty OpenPaneLengthProperty = BindableProperty.Create("OpenPaneLength", typeof(double), typeof(ZtNavigationView), 320.0);
        ...
        public static readonly BindableProperty OverflowLabelModeProperty = BindableProperty.Create("OverflowLabelMode", typeof(ViewOverflowLabelMode), typeof(ZtNavigationView), ViewOverflowLabelMode.MoreLabel);
        ...
        public static readonly BindableProperty PaneDisplayModeProperty = BindableProperty.Create("PaneDisplayMode", typeof(ViewPaneDisplayMode), typeof(ZtNavigationView), ViewPaneDisplayMode.Auto);
        ...
        public static readonly BindableProperty SelectedItemProperty = BindableProperty.Create("SelectedItem", typeof(object), typeof(ZtNavigationView));
